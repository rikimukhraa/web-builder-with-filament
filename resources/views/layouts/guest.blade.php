...
<body class="antialiased h-full bg-white bg-[url('https://laravel.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-black/90 dark:bg-blend-multiply dark:bg-[url('https://wallpaper.dog/large/20511836.jpg')]">
    ...
    <x-inc.footer-panel>
        ...
        {{ config('app.name', 'Laravel') }}</span>
            ...
            <div class="px-4 py-6 bg-gray-100 dark:bg-green-950/10 md:flex  sm:text-center  md:items-center md:justify-between rounded-lg sm:justify-center">
                <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="#">BigData</a>. All Rights Reserved.
                </span>
