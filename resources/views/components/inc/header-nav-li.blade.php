...
<ul class="flex flex-col p-4 mt-4 font-medium border rounded-lg md:p-0 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
   {{ $navli }}
    ...
    {{-- <nav
        class="fixed z-30 w-full  bg-white/80 border-b border-gray-100 dark:bg-black/80 dark:border-gray-900 py-3 px-4">
        <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto ">
            <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span
                    class="self-center text-2xl font-semibold whitespace-nowrap text-green-950 dark:text-green-200">Laravel</span>
            </a>
